...
export const Cookies = () => {
  ...
  return(
    <>
      <div style={{display: cookieAccepted?"none":"block"}} className="hidden fixed overflow-y-auto w-[80%] text-center left-[10%] h-[80%] top-[10%] bg-basiskleur p-[20px] rounded-lg text-liturgischekleur min-h-[20px] z-[5000]">
        ...
        <div className="my-[10px] px-[20px] text-justify mb-[70px]">
          ...
          <ul className="list-disc px-[25px]">
            <li>Wij gebruiken geen cookies, analytics of een andere soort trackers</li>
      ...
      <div style={{display: cookieAccepted?"none":"block"}} className="hidden opacity-90 fixed bg-liturgischekleur z-[4999] left-[0px] w-full h-full top-[0px]"></div>
    </>
  ) 
}
