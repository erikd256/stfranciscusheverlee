...
export const Cookies = () => {
  ...
  return(
    <>
      <div style={{display: cookieAccepted?"none":"block"}} className="fixed overflow-y-auto w-[80%] text-center left-[10%] h-[80%] top-[10%] bg-basiskleur p-[20px] rounded-lg text-liturgischekleur min-h-[20px] z-[5000]">
