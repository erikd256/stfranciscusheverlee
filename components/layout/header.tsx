...
export const Header = ({ data }) => {
  ...
  return (
    <>
      ...
      <span className="hidden mo:block text-center  border border-basiskleur rounded mr-2 py-2 px-4 bg-liturgischekleur text-basiskleur"><a href="#">Catechese</a></span>
      ...
      <span className="block mo:hidden text-center border border-basiskleur rounded mr-2 py-2 px-4 bg-liturgischekleur text-basiskleur w-5/6"><a href="/contact">Menu</a></span>
      </div>
    </>
  );
};
