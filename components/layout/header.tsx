...
export const Header = ({ data }) => {
  ...
  return (
    <>
      <div className="flex overflow-x-hidden items-center justify-between bg-liturgischekleur border-b-4 border-basiskleur"><img src="/assets/Kerk_Logo.jpg" className={`h-[250px]  border-r-4 border-basiskleur`}/><span className="text-4xl absolute w-full text-center">Sint Franciscusparochie Heverlee</span></div>
      <Container className={`overflow-x-hidden flex items-center justify-between z-40 sticky top-0 bg-vierdekleur p-0 text-basiskleur w-full border-solid border-b-4 border-basiskleur flex-1 mr-2 py-[10px] `}>
