...
export const Header = ({ data }) => {
  ...
  return (
    <>
      ...
      <span className="hidden mo:block text-center  border border-basiskleur rounded mr-2 py-2 px-4 bg-liturgischekleur text-basiskleur"><a href="/sacramenten">Sacramenten</a></span>
