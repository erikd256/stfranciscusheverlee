...
export const Header = ({ data }) => {
  ...
  return (
    <>
      ...
      <button className="hidden mo:block text-center  border border-basiskleur rounded mr-2 py-2 px-4 bg-liturgischekleur text-basiskleur"><a href="/inks">Links</a></button>
