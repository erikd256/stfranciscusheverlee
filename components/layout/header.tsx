...
export const Header = ({ data }) => {
  ...
  return (
    <>
      ...
      <div className={`overflow-x-hidden flex text-center items-center content-center	z-40 bg-vierdekleur text-basiskleur w-full border-solid border-b-4 border-basiskleur flex-1 mr-2 p-[15px] sticky top-0`}>
