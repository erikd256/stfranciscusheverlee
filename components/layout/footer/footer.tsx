  ...
  return (
    ...
    <footer className={`bg-basiskleur pb-[75px] min-h-[500px] relative pt-[20px]`}>
        ...
        <div className="overflow-scroll text-center text-liturgischekleur w-5/6 m-auto mt-[20px]">
          ...
          <a href="https://github.com/erikd256/stfranciscusheverlee/commits/main" target="_blank"><img className="mx-auto mt-2 mo:right-[20%] mo:absolute" src="https://img.shields.io/github/last-commit/erikd256/stfranciscusheverlee"/></a>
        </div>
    </footer>
    </>
  );
