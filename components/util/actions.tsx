...
export const Actions = ({
  ...
  const linkButtonColorClasses = {
    ...
    yellow:
      "text-basiskleur dark:basiskleur hover:text-basiskleur dark:hover:text-basiskleur",
  };

  return (
    <div className={`flex flex-wrap items-center max-w-5/6 gap-y-4 gap-x-6 ${className}`}>
      {actions &&
